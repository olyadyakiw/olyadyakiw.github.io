...
function initFullPageSlider() {
	var init = false;
	var swiper;
	const slider = document.querySelector(".swiper-full");
	function swiperCard() {
	  if (window.innerWidth >= 666) {
	    if (!init) {
		  ...
		  const slides = document.querySelectorAll('.swiper-full-slide');
		  swiper.on("slideChange", function() {
			const header = document.querySelector('.header');

			for (let i = 0; i < slides.length; i++) {
				slides[i].setAttribute('slide', i + 1);
			}
		  ...
		  swiper.on('beforeTransitionStart', function() {
			slides.forEach(slide => {
				if(slide.classList.contains('swiper-slide-active')) {
					const animated = slide.querySelectorAll('.animated');
